...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternshipStudent", b =>
                {
                    b.Property<int>("AppliedInternshipsID")
                        .HasColumnType("int");

                    b.Property<string>("AppliedStudentsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AppliedInternshipsID", "AppliedStudentsId");

                    b.HasIndex("AppliedStudentsId");

                    b.ToTable("InternshipStudent");
                });

            modelBuilder.Entity("InternshipStudent1", b =>
                {
                    b.Property<int>("PreviousInternshipsID")
                        .HasColumnType("int");

                    b.Property<string>("PreviousStudentsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("PreviousInternshipsID", "PreviousStudentsId");

                    b.HasIndex("PreviousStudentsId");

                    b.ToTable("InternshipStudent1");
                });

            modelBuilder.Entity("InternshipStudent2", b =>
                {
                    b.Property<int>("WishlistID")
                        .HasColumnType("int");

                    b.Property<string>("WishlistStudentsId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("WishlistID", "WishlistStudentsId");

                    b.HasIndex("WishlistStudentsId");

                    b.ToTable("InternshipStudent2");
                });
            ...
            modelBuilder.Entity("Models.InternshipApplication", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.Rating", b =>
                {
                    ...
                    b.Property<string>("GeneralImpression")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("SelectionLength")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InternshipStudent", b =>
                {
                    b.HasOne("Models.Internship", null)
                        .WithMany()
                        .HasForeignKey("AppliedInternshipsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InternshipStudent1", b =>
                {
                    b.HasOne("Models.Internship", null)
                        .WithMany()
                        .HasForeignKey("PreviousInternshipsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.Student", null)
                        .WithMany()
                        .HasForeignKey("PreviousStudentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("InternshipStudent2", b =>
                {
                    ...
                    b.HasOne("Models.Student", null)
                        .WithMany()
                        .HasForeignKey("WishlistStudentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Models.InternshipApplication", b =>
                {
                    b.HasOne("Models.Internship", "Internship")
