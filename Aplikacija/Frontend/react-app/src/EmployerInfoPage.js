      ...
      <Box>
        ...
        <TabPanel value={value} index={0}>
          ...
          >
            ...
            <Typography align="center" sx={{ m: 1 }}>
              {" "}
              <PublicIcon style={{ color: "red" }} /> http://
              {employerData.companyName.toLowerCase()}.com{" "}
            </Typography>
          </Grid>
        ...
        <TabPanel value={value} index={1}>
          <Box sx={{ mb: 1 }} variant="outlined">
          <Grid style={{marginBottom:10, display:"flex", flexDirection:"row", justifyContent:"center", alignItems:"center"}} item xs={12} md={6} lg={6}> 
                  <TextField style={{width:"80%", justifySelf:"center", alignSelf:"center"}}
                    onChange={(event) => {
